...
associated to a single detector level event. As this setting does not accommodate
...
This is clear indications that the naive GAN approach does not exploit 
